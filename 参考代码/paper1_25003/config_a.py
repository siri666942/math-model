...
Paper cumcm25003 baseline parameters
"""
import numpy as np
...
# PSO 优化参数
# ============================================================
PSO_SWARM_SIZE = 80      # 粒子群规模 (论文: 80 particles)
PSO_MAX_ITER = 160       # 最大迭代次数 (论文: 160 iterations)
...
PAPER_RESULTS = {
    'P1': 1.392,
    'P2': 4.716,  # theta=5.86deg=0.1023rad, v=116.27m/s
    'P3': 5.625,  # theta=10.35deg=0.1807rad, v=101.80m/s
    'P4': 12.544,
    'P5': 17.413,
}
